import {
  ...
  useMounted,
  usePrevious
} from "./chunk-WMLA6MZS.js";
import {
  require_classnames,
  require_jsx_runtime,
  useBootstrapPrefix
} from "./chunk-MENRAF6G.js";
import {
  require_react_dom
...
var TransitionWrapper = import_react12.default.forwardRef(({
  onEnter,
  onEntering,
  onEntered,
  onExit,
  ...
  const handleEnter = (0, import_react12.useCallback)(normalize(onEnter), [onEnter]);
  const handleEntering = (0, import_react12.useCallback)(normalize(onEntering), [onEntering]);
  const handleEntered = (0, import_react12.useCallback)(normalize(onEntered), [onEntered]);
  const handleExit = (0, import_react12.useCallback)(normalize(onExit), [onExit]);
  const handleExiting = (0, import_react12.useCallback)(normalize(onExiting), [onExiting]);
  const handleExited = (0, import_react12.useCallback)(normalize(onExited), [onExited]);
  const handleAddEndListener = (0, import_react12.useCallback)(normalize(addEndListener), [addEndListener]);
  return (0, import_jsx_runtime5.jsx)(Transition_default, {
    ...
    ) : import_react12.default.cloneElement(children, {
      ref: attachRef
    })
  });
});
...
var Fade = React6.forwardRef(({
  ...
  const handleEnter = (0, import_react13.useCallback)((node, isAppearing) => {
...
var OffcanvasToggling = React7.forwardRef(({
  bsPrefix,
  className,
  children,
  in: inProp = false,
...
var CloseButton = React9.forwardRef(({
  ...
  ...props
}, ref) => (0, import_jsx_runtime8.jsx)("button", {
  ref,
  type: "button",
...
var AbstractModalHeader = React10.forwardRef(({
  closeLabel = "Close",
  closeVariant,
  closeButton = false,
  onHide,
  ...
  const context = (0, import_react14.useContext)(ModalContext_default);
...
var OffcanvasHeader = React11.forwardRef(({
  bsPrefix,
  className,
  closeLabel = "Close",
  closeButton = false,
...
var divWithClassName_default = (className) => React12.forwardRef((p, ref) => (0, import_jsx_runtime12.jsx)("div", {
  ...p,
  ref,
...
function DialogTransition(props) {
  return (0, import_jsx_runtime13.jsx)(OffcanvasToggling_default, {
    ...props
  });
}
...
var Offcanvas = React13.forwardRef(({
  bsPrefix,
  className,
  children,
  ...
  const modalManager = (0, import_react15.useRef)();
  bsPrefix = useBootstrapPrefix(bsPrefix, "offcanvas");
  const {
    onToggle
  } = (0, import_react15.useContext)(NavbarContext_default) || {};
  const [showOffcanvas, setShowOffcanvas] = (0, import_react15.useState)(false);
  ...
  const renderBackdrop = (0, import_react15.useCallback)((backdropProps) => (0, import_jsx_runtime13.jsx)("div", {
    ...backdropProps,
  ...
  return (0, import_jsx_runtime15.jsxs)(import_jsx_runtime14.Fragment, {
    children: [!showOffcanvas && (responsive || renderStaticNode) && renderDialog({}), (0, import_jsx_runtime13.jsx)(ModalContext_default.Provider, {
      value: modalContext,
...
object-assign/index.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-YCH72REF.js.map
